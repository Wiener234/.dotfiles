...
source_makepkg_config() {
	...
	local MAKEPKG_CONF=${1:-${MAKEPKG_CONF:-/home/runner/work/pspdev/pspdev/pspdev/etc/makepkg.conf}}
	...
	if [[ $MAKEPKG_CONF = "/home/runner/work/pspdev/pspdev/pspdev/etc/makepkg.conf" ]]; then
