...
#define HAVE_msubsidi4 (!TARGET_64BIT && (ISA_HAS_MSAC || GENERATE_MADD_MSUB || ISA_HAS_DSP || TARGET_ALLEGREX))
#define HAVE_umsubsidi4 (!TARGET_64BIT && (ISA_HAS_MSAC || GENERATE_MADD_MSUB || ISA_HAS_DSP || TARGET_ALLEGREX))
...
#define HAVE_maddsidi4 ((TARGET_MAD || ISA_HAS_MACC || GENERATE_MADD_MSUB || ISA_HAS_DSP || TARGET_ALLEGREX) \
   && !TARGET_64BIT)
#define HAVE_umaddsidi4 ((TARGET_MAD || ISA_HAS_MACC || GENERATE_MADD_MSUB || ISA_HAS_DSP || TARGET_ALLEGREX) \
   && !TARGET_64BIT)
...
#define HAVE_mov_lwl ((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
    && mips_mem_fits_mode_p (SImode, operands[1]))
#define HAVE_mov_ldl (((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
    && mips_mem_fits_mode_p (DImode, operands[1])) && (TARGET_64BIT))
#define HAVE_mov_lwr ((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
    && mips_mem_fits_mode_p (SImode, operands[1]))
#define HAVE_mov_ldr (((!TARGET_MIPS16 || ISA_HAS_MIPS16E2) \
    && mips_mem_fits_mode_p (DImode, operands[1])) && (TARGET_64BIT))
...
#define HAVE_mov_swr (!TARGET_MIPS16 \
   && mips_mem_fits_mode_p (SImode, operands[0]))
#define HAVE_mov_sdr ((!TARGET_MIPS16 \
   && mips_mem_fits_mode_p (DImode, operands[0])) && (TARGET_64BIT))
#define HAVE_mov_swl_mips16e2 (TARGET_MIPS16 && ISA_HAS_MIPS16E2 \
   && mips_mem_fits_mode_p (SImode, operands[0]))
#define HAVE_mov_sdl_mips16e2 ((TARGET_MIPS16 && ISA_HAS_MIPS16E2 \
   && mips_mem_fits_mode_p (DImode, operands[0])) && (TARGET_64BIT))
#define HAVE_mov_swr_mips16e2 (TARGET_MIPS16 && ISA_HAS_MIPS16E2 \
   && mips_mem_fits_mode_p (SImode, operands[0]))
#define HAVE_mov_sdr_mips16e2 ((TARGET_MIPS16 && ISA_HAS_MIPS16E2 \
   && mips_mem_fits_mode_p (DImode, operands[0])) && (TARGET_64BIT))
...
#define HAVE_bswapsi2 (ISA_HAS_WSBW)
#define HAVE_bswapsi2_split (ISA_HAS_WSBH && ISA_HAS_ROR)
...
#define HAVE_mips_hb_return_internal 1
...
#define HAVE_sminsi3 (TARGET_ALLEGREX)
#define HAVE_smaxsi3 (TARGET_ALLEGREX)
#define HAVE_allegrex_bitrevsi2 (TARGET_ALLEGREX)
#define HAVE_allegrex_closi2 (TARGET_ALLEGREX)
#define HAVE_allegrex_sync (TARGET_ALLEGREX)
#define HAVE_allegrex_cache (TARGET_ALLEGREX)
#define HAVE_allegrex_ceilsfsi2 (TARGET_ALLEGREX)
#define HAVE_allegrex_floorsfsi2 (TARGET_ALLEGREX)
#define HAVE_allegrex_roundsfsi2 (TARGET_ALLEGREX)
...
#define HAVE_allegrex_ctzsi2 (TARGET_ALLEGREX)
#define HAVE_allegrex_ctosi2 (TARGET_ALLEGREX)
...
extern rtx        gen_mov_swl_mips16e2                (rtx, rtx, rtx);
extern rtx        gen_mov_sdl_mips16e2                (rtx, rtx, rtx);
extern rtx        gen_mov_swr_mips16e2                (rtx, rtx, rtx);
extern rtx        gen_mov_sdr_mips16e2                (rtx, rtx, rtx);
...
extern rtx        gen_bswapsi2_split                  (rtx, rtx);
...
extern rtx        gen_mips_hb_return_internal         (rtx);
...
extern rtx        gen_allegrex_bitrevsi2              (rtx, rtx);
extern rtx        gen_allegrex_closi2                 (rtx, rtx);
extern rtx        gen_allegrex_sync                   (void);
extern rtx        gen_allegrex_cache                  (rtx, rtx);
extern rtx        gen_allegrex_ceilsfsi2              (rtx, rtx);
extern rtx        gen_allegrex_floorsfsi2             (rtx, rtx);
extern rtx        gen_allegrex_roundsfsi2             (rtx, rtx);
...
extern rtx        gen_allegrex_ctzsi2                 (rtx, rtx);
extern rtx        gen_allegrex_ctosi2                 (rtx, rtx);
