...
#endif
#ifdef GENERATOR_FILE
extern int mips_opt_explicit_relocs;
#else
  int x_mips_opt_explicit_relocs;
#define mips_opt_explicit_relocs global_options.x_mips_opt_explicit_relocs
#endif
#ifdef GENERATOR_FILE
...
#endif
#ifdef GENERATOR_FILE
extern int TARGET_MIPS16E2;
#else
  int x_TARGET_MIPS16E2;
#define TARGET_MIPS16E2 global_options.x_TARGET_MIPS16E2
#endif
#ifdef GENERATOR_FILE
...
#else
  const char *x_mips_preferred_stack_boundary_string;
#define mips_preferred_stack_boundary_string global_options.x_mips_preferred_stack_boundary_string
#endif
#ifdef GENERATOR_FILE
...
#define MASK_FIX_R10000 (1U << 6)
#define MASK_FIX_R4000 (1U << 7)
#define MASK_FIX_R4400 (1U << 8)
#define MASK_FIX_R5900 (1U << 9)
...
#define MASK_LOONGSON_EXT (1U << 18)
#define MASK_LOONGSON_MMI (1U << 19)
#define MASK_MEMCPY (1U << 20)
#define MASK_MICROMIPS (1U << 21)
#define MASK_MSA (1U << 22)
#define MASK_ODD_SPREG (1U << 23)
#define MASK_PAIRED_SINGLE_FLOAT (1U << 24)
#define MASK_RELAX_PIC_CALLS (1U << 25)
#define MASK_SMARTMIPS (1U << 26)
#define MASK_SPLIT_ADDRESSES (1U << 27)
#define MASK_SYNCI (1U << 28)
#define MASK_VR4130_ALIGN (1U << 29)

/* ABICALLS mask */
#define TARGET_ABICALLS ((target_flags & MASK_ABICALLS) != 0)
#define TARGET_ABICALLS_P(target_flags) (((target_flags) & MASK_ABICALLS) != 0)
#define TARGET_ABICALLS_OPTS_P(opts) (((opts->x_target_flags) & MASK_ABICALLS) != 0)
...
#define TARGET_BRANCHLIKELY_OPTS_P(opts) (((opts->x_target_flags) & MASK_BRANCHLIKELY) != 0)
...
#define TARGET_CHECK_ZERO_DIV_OPTS_P(opts) (((opts->x_target_flags) & MASK_CHECK_ZERO_DIV) != 0)
...
#define TARGET_DIVIDE_BREAKS_OPTS_P(opts) (((opts->x_target_flags) & MASK_DIVIDE_BREAKS) != 0)
...
#define TARGET_SINGLE_FLOAT_OPTS_P(opts) (((opts->x_target_flags) & MASK_SINGLE_FLOAT) != 0)
...
#define TARGET_BIG_ENDIAN_OPTS_P(opts) (((opts->x_target_flags) & MASK_BIG_ENDIAN) != 0)
...
#define TARGET_FIX_R10000_OPTS_P(opts) (((opts->x_target_flags) & MASK_FIX_R10000) != 0)
...
#define TARGET_FIX_R4000_OPTS_P(opts) (((opts->x_target_flags) & MASK_FIX_R4000) != 0)
...
#define TARGET_FIX_R4400_OPTS_P(opts) (((opts->x_target_flags) & MASK_FIX_R4400) != 0)
...
#define TARGET_FIX_R5900_OPTS_P(opts) (((opts->x_target_flags) & MASK_FIX_R5900) != 0)
...
#define TARGET_FLOAT64_OPTS_P(opts) (((opts->x_target_flags) & MASK_FLOAT64) != 0)
...
#define TARGET_FLOATXX_OPTS_P(opts) (((opts->x_target_flags) & MASK_FLOATXX) != 0)
...
#define TARGET_64BIT_OPTS_P(opts) (((opts->x_target_flags) & MASK_64BIT) != 0)
...
#define TARGET_SOFT_FLOAT_ABI_OPTS_P(opts) (((opts->x_target_flags) & MASK_SOFT_FLOAT_ABI) != 0)
...
#define TARGET_IMADD_OPTS_P(opts) (((opts->x_target_flags) & MASK_IMADD) != 0)
...
#define TARGET_MIPS16_OPTS_P(opts) (((opts->x_target_flags) & MASK_MIPS16) != 0)
...
#define TARGET_LLSC_OPTS_P(opts) (((opts->x_target_flags) & MASK_LLSC) != 0)
...
#define TARGET_LONG64_OPTS_P(opts) (((opts->x_target_flags) & MASK_LONG64) != 0)
...
#define TARGET_LOONGSON_EXT_OPTS_P(opts) (((opts->x_target_flags) & MASK_LOONGSON_EXT) != 0)
...
#define TARGET_LOONGSON_MMI_OPTS_P(opts) (((opts->x_target_flags) & MASK_LOONGSON_MMI) != 0)
...
#define TARGET_MEMCPY_OPTS_P(opts) (((opts->x_target_flags) & MASK_MEMCPY) != 0)
...
#define TARGET_MICROMIPS_OPTS_P(opts) (((opts->x_target_flags) & MASK_MICROMIPS) != 0)
...
#define TARGET_MSA_OPTS_P(opts) (((opts->x_target_flags) & MASK_MSA) != 0)
...
#define TARGET_ODD_SPREG_OPTS_P(opts) (((opts->x_target_flags) & MASK_ODD_SPREG) != 0)
...
#define TARGET_PAIRED_SINGLE_FLOAT_OPTS_P(opts) (((opts->x_target_flags) & MASK_PAIRED_SINGLE_FLOAT) != 0)
...
#define TARGET_RELAX_PIC_CALLS_OPTS_P(opts) (((opts->x_target_flags) & MASK_RELAX_PIC_CALLS) != 0)
...
#define TARGET_SMARTMIPS_OPTS_P(opts) (((opts->x_target_flags) & MASK_SMARTMIPS) != 0)
...
#define TARGET_SPLIT_ADDRESSES_OPTS_P(opts) (((opts->x_target_flags) & MASK_SPLIT_ADDRESSES) != 0)
...
#define TARGET_SYNCI_OPTS_P(opts) (((opts->x_target_flags) & MASK_SYNCI) != 0)
...
#define TARGET_VR4130_ALIGN_OPTS_P(opts) (((opts->x_target_flags) & MASK_VR4130_ALIGN) != 0)
...
enum opt_code
{
  ...
  OPT_MQ = 419,                              /* -MQ */
  OPT_MT = 420,                              /* -MT */
  OPT_Mmodules = 421,                        /* -Mmodules */
  OPT_Mno_modules = 422,                     /* -Mno-modules */
  OPT_N = 423,                               /* -N */
  OPT_O = 424,                               /* -O */
  OPT_Ofast = 425,                           /* -Ofast */
  OPT_Og = 426,                              /* -Og */
  ...
  OPT_Tbss_ = 437,                           /* -Tbss= */
  OPT_Tdata = 438,                           /* -Tdata */
  OPT_Tdata_ = 439,                          /* -Tdata= */
  OPT_Ttext = 440,                           /* -Ttext */
  OPT_Ttext_ = 441,                          /* -Ttext= */
  OPT_U = 442,                               /* -U */
  /* OPT_W = 443, */                         /* -W */
  OPT_WNSObject_attribute = 444,             /* -WNSObject-attribute */
  OPT_Wa_ = 445,                             /* -Wa, */
  OPT_Wabi = 446,                            /* -Wabi */
  OPT_Wabi_tag = 447,                        /* -Wabi-tag */
  OPT_Wabi_ = 448,                           /* -Wabi= */
  OPT_Wabsolute_value = 449,                 /* -Wabsolute-value */
  OPT_Waddress = 450,                        /* -Waddress */
  OPT_Waddress_of_packed_member = 451,       /* -Waddress-of-packed-member */
  OPT_Waggregate_return = 452,               /* -Waggregate-return */
  OPT_Waggressive_loop_optimizations = 453,  /* -Waggressive-loop-optimizations */
  OPT_Waliasing = 454,                       /* -Waliasing */
  OPT_Walign_commons = 455,                  /* -Walign-commons */
  /* OPT_Waligned_new = 456, */              /* -Waligned-new */
  OPT_Waligned_new_ = 457,                   /* -Waligned-new= */
  OPT_Wall = 458,                            /* -Wall */
  OPT_Walloc_size = 459,                     /* -Walloc-size */
  ...
  OPT_Wanalyzer_infinite_loop = 481,         /* -Wanalyzer-infinite-loop */
  OPT_Wanalyzer_infinite_recursion = 482,    /* -Wanalyzer-infinite-recursion */
  OPT_Wanalyzer_jump_through_null = 483,     /* -Wanalyzer-jump-through-null */
  OPT_Wanalyzer_malloc_leak = 484,           /* -Wanalyzer-malloc-leak */
  OPT_Wanalyzer_mismatching_deallocation = 485,/* -Wanalyzer-mismatching-deallocation */
  OPT_Wanalyzer_null_argument = 486,         /* -Wanalyzer-null-argument */
  OPT_Wanalyzer_null_dereference = 487,      /* -Wanalyzer-null-dereference */
  OPT_Wanalyzer_out_of_bounds = 488,         /* -Wanalyzer-out-of-bounds */
  OPT_Wanalyzer_overlapping_buffers = 489,   /* -Wanalyzer-overlapping-buffers */
  OPT_Wanalyzer_possible_null_argument = 490,/* -Wanalyzer-possible-null-argument */
  OPT_Wanalyzer_possible_null_dereference = 491,/* -Wanalyzer-possible-null-dereference */
  OPT_Wanalyzer_putenv_of_auto_var = 492,    /* -Wanalyzer-putenv-of-auto-var */
  OPT_Wanalyzer_shift_count_negative = 493,  /* -Wanalyzer-shift-count-negative */
  OPT_Wanalyzer_shift_count_overflow = 494,  /* -Wanalyzer-shift-count-overflow */
  OPT_Wanalyzer_stale_setjmp_buffer = 495,   /* -Wanalyzer-stale-setjmp-buffer */
  OPT_Wanalyzer_symbol_too_complex = 496,    /* -Wanalyzer-symbol-too-complex */
  OPT_Wanalyzer_tainted_allocation_size = 497,/* -Wanalyzer-tainted-allocation-size */
  OPT_Wanalyzer_tainted_array_index = 498,   /* -Wanalyzer-tainted-array-index */
  OPT_Wanalyzer_tainted_assertion = 499,     /* -Wanalyzer-tainted-assertion */
  OPT_Wanalyzer_tainted_divisor = 500,       /* -Wanalyzer-tainted-divisor */
  OPT_Wanalyzer_tainted_offset = 501,        /* -Wanalyzer-tainted-offset */
  OPT_Wanalyzer_tainted_size = 502,          /* -Wanalyzer-tainted-size */
  OPT_Wanalyzer_too_complex = 503,           /* -Wanalyzer-too-complex */
  OPT_Wanalyzer_undefined_behavior_strtok = 504,/* -Wanalyzer-undefined-behavior-strtok */
  OPT_Wanalyzer_unsafe_call_within_signal_handler = 505,/* -Wanalyzer-unsafe-call-within-signal-handler */
  OPT_Wanalyzer_use_after_free = 506,        /* -Wanalyzer-use-after-free */
  OPT_Wanalyzer_use_of_pointer_in_stale_stack_frame = 507,/* -Wanalyzer-use-of-pointer-in-stale-stack-frame */
  OPT_Wanalyzer_use_of_uninitialized_value = 508,/* -Wanalyzer-use-of-uninitialized-value */
  OPT_Wanalyzer_va_arg_type_mismatch = 509,  /* -Wanalyzer-va-arg-type-mismatch */
  OPT_Wanalyzer_va_list_exhausted = 510,     /* -Wanalyzer-va-list-exhausted */
  OPT_Wanalyzer_va_list_leak = 511,          /* -Wanalyzer-va-list-leak */
  OPT_Wanalyzer_va_list_use_after_va_end = 512,/* -Wanalyzer-va-list-use-after-va-end */
  OPT_Wanalyzer_write_to_const = 513,        /* -Wanalyzer-write-to-const */
  OPT_Wanalyzer_write_to_string_literal = 514,/* -Wanalyzer-write-to-string-literal */
  OPT_Wargument_mismatch = 515,              /* -Wargument-mismatch */
  OPT_Warith_conversion = 516,               /* -Warith-conversion */
  /* OPT_Warray_bounds = 517, */             /* -Warray-bounds */
  OPT_Warray_bounds_ = 518,                  /* -Warray-bounds= */
  OPT_Warray_compare = 519,                  /* -Warray-compare */
  /* OPT_Warray_parameter = 520, */          /* -Warray-parameter */
  OPT_Warray_parameter_ = 521,               /* -Warray-parameter= */
  OPT_Warray_temporaries = 522,              /* -Warray-temporaries */
  OPT_Wassign_intercept = 523,               /* -Wassign-intercept */
  /* OPT_Wattribute_alias = 524, */          /* -Wattribute-alias */
  OPT_Wattribute_alias_ = 525,               /* -Wattribute-alias= */
  OPT_Wattribute_warning = 526,              /* -Wattribute-warning */
  OPT_Wattributes = 527,                     /* -Wattributes */
  OPT_Wattributes_ = 528,                    /* -Wattributes= */
  OPT_Wbad_function_cast = 529,              /* -Wbad-function-cast */
  /* OPT_Wbidi_chars = 530, */               /* -Wbidi-chars */
  OPT_Wbidi_chars_ = 531,                    /* -Wbidi-chars= */
  OPT_Wbool_compare = 532,                   /* -Wbool-compare */
  OPT_Wbool_operation = 533,                 /* -Wbool-operation */
  OPT_Wbuiltin_declaration_mismatch = 534,   /* -Wbuiltin-declaration-mismatch */
  OPT_Wbuiltin_macro_redefined = 535,        /* -Wbuiltin-macro-redefined */
  OPT_Wc___compat = 536,                     /* -Wc++-compat */
  /* OPT_Wc__0x_compat = 537, */             /* -Wc++0x-compat */
  OPT_Wc__11_compat = 538,                   /* -Wc++11-compat */
  OPT_Wc__11_extensions = 539,               /* -Wc++11-extensions */
  OPT_Wc__14_compat = 540,                   /* -Wc++14-compat */
  OPT_Wc__14_extensions = 541,               /* -Wc++14-extensions */
  OPT_Wc__17_compat = 542,                   /* -Wc++17-compat */
  OPT_Wc__17_extensions = 543,               /* -Wc++17-extensions */
  /* OPT_Wc__1z_compat = 544, */             /* -Wc++1z-compat */
  OPT_Wc__20_compat = 545,                   /* -Wc++20-compat */
  OPT_Wc__20_extensions = 546,               /* -Wc++20-extensions */
  OPT_Wc__23_extensions = 547,               /* -Wc++23-extensions */
  OPT_Wc__26_extensions = 548,               /* -Wc++26-extensions */
  /* OPT_Wc__2a_compat = 549, */             /* -Wc++2a-compat */
  OPT_Wc_binding_type = 550,                 /* -Wc-binding-type */
  OPT_Wc11_c23_compat = 551,                 /* -Wc11-c23-compat */
  /* OPT_Wc11_c2x_compat = 552, */           /* -Wc11-c2x-compat */
  OPT_Wc90_c99_compat = 553,                 /* -Wc90-c99-compat */
  OPT_Wc99_c11_compat = 554,                 /* -Wc99-c11-compat */
  OPT_Wcalloc_transposed_args = 555,         /* -Wcalloc-transposed-args */
  OPT_Wcannot_profile = 556,                 /* -Wcannot-profile */
  OPT_Wcase_enum = 557,                      /* -Wcase-enum */
  OPT_Wcast_align = 558,                     /* -Wcast-align */
  OPT_Wcast_align_strict = 559,              /* -Wcast-align=strict */
  OPT_Wcast_function_type = 560,             /* -Wcast-function-type */
  OPT_Wcast_qual = 561,                      /* -Wcast-qual */
  OPT_Wcast_result = 562,                    /* -Wcast-result */
  OPT_Wcast_user_defined = 563,              /* -Wcast-user-defined */
  /* OPT_Wcatch_value = 564, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 565,                   /* -Wcatch-value= */
  OPT_Wchanges_meaning = 566,                /* -Wchanges-meaning */
  OPT_Wchar_subscripts = 567,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 568,           /* -Wcharacter-truncation */
  OPT_Wchkp = 569,                           /* -Wchkp */
  OPT_Wclass_conversion = 570,               /* -Wclass-conversion */
  OPT_Wclass_memaccess = 571,                /* -Wclass-memaccess */
  OPT_Wclobbered = 572,                      /* -Wclobbered */
  OPT_Wcomma_subscript = 573,                /* -Wcomma-subscript */
  OPT_Wcomment = 574,                        /* -Wcomment */
  /* OPT_Wcomments = 575, */                 /* -Wcomments */
  OPT_Wcompare_distinct_pointer_types = 576, /* -Wcompare-distinct-pointer-types */
  OPT_Wcompare_reals = 577,                  /* -Wcompare-reals */
  OPT_Wcomplain_wrong_lang = 578,            /* -Wcomplain-wrong-lang */
  OPT_Wconditionally_supported = 579,        /* -Wconditionally-supported */
  OPT_Wconversion = 580,                     /* -Wconversion */
  OPT_Wconversion_extra = 581,               /* -Wconversion-extra */
  OPT_Wconversion_null = 582,                /* -Wconversion-null */
  OPT_Wcoverage_invalid_line_number = 583,   /* -Wcoverage-invalid-line-number */
  OPT_Wcoverage_mismatch = 584,              /* -Wcoverage-mismatch */
  OPT_Wcoverage_too_many_conditions = 585,   /* -Wcoverage-too-many-conditions */
  OPT_Wcpp = 586,                            /* -Wcpp */
  OPT_Wctad_maybe_unsupported = 587,         /* -Wctad-maybe-unsupported */
  OPT_Wctor_dtor_privacy = 588,              /* -Wctor-dtor-privacy */
  OPT_Wdangling_else = 589,                  /* -Wdangling-else */
  /* OPT_Wdangling_pointer = 590, */         /* -Wdangling-pointer */
  OPT_Wdangling_pointer_ = 591,              /* -Wdangling-pointer= */
  OPT_Wdangling_reference = 592,             /* -Wdangling-reference */
  OPT_Wdate_time = 593,                      /* -Wdate-time */
  OPT_Wdeclaration_after_statement = 594,    /* -Wdeclaration-after-statement */
  OPT_Wdeclaration_missing_parameter_type = 595,/* -Wdeclaration-missing-parameter-type */
  OPT_Wdelete_incomplete = 596,              /* -Wdelete-incomplete */
  OPT_Wdelete_non_virtual_dtor = 597,        /* -Wdelete-non-virtual-dtor */
  OPT_Wdeprecated = 598,                     /* -Wdeprecated */
  OPT_Wdeprecated_copy = 599,                /* -Wdeprecated-copy */
  OPT_Wdeprecated_copy_dtor = 600,           /* -Wdeprecated-copy-dtor */
  OPT_Wdeprecated_declarations = 601,        /* -Wdeprecated-declarations */
  OPT_Wdeprecated_enum_enum_conversion = 602,/* -Wdeprecated-enum-enum-conversion */
  OPT_Wdeprecated_enum_float_conversion = 603,/* -Wdeprecated-enum-float-conversion */
  OPT_Wdesignated_init = 604,                /* -Wdesignated-init */
  OPT_Wdisabled_optimization = 605,          /* -Wdisabled-optimization */
  OPT_Wdiscarded_array_qualifiers = 606,     /* -Wdiscarded-array-qualifiers */
  OPT_Wdiscarded_qualifiers = 607,           /* -Wdiscarded-qualifiers */
  OPT_Wdiv_by_zero = 608,                    /* -Wdiv-by-zero */
  OPT_Wdo_subscript = 609,                   /* -Wdo-subscript */
  OPT_Wdouble_promotion = 610,               /* -Wdouble-promotion */
  OPT_Wduplicate_decl_specifier = 611,       /* -Wduplicate-decl-specifier */
  OPT_Wduplicated_branches = 612,            /* -Wduplicated-branches */
  OPT_Wduplicated_cond = 613,                /* -Wduplicated-cond */
  OPT_Weffc__ = 614,                         /* -Weffc++ */
  OPT_Welaborated_enum_base = 615,           /* -Welaborated-enum-base */
  OPT_Wempty_body = 616,                     /* -Wempty-body */
  OPT_Wendif_labels = 617,                   /* -Wendif-labels */
  OPT_Wenum_compare = 618,                   /* -Wenum-compare */
  OPT_Wenum_conversion = 619,                /* -Wenum-conversion */
  OPT_Wenum_int_mismatch = 620,              /* -Wenum-int-mismatch */
  OPT_Werror = 621,                          /* -Werror */
  /* OPT_Werror_implicit_function_declaration = 622, *//* -Werror-implicit-function-declaration */
  OPT_Werror_ = 623,                         /* -Werror= */
  OPT_Wexceptions = 624,                     /* -Wexceptions */
  OPT_Wexpansion_to_defined = 625,           /* -Wexpansion-to-defined */
  OPT_Wextra = 626,                          /* -Wextra */
  OPT_Wextra_semi = 627,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 628,                   /* -Wfatal-errors */
  OPT_Wflex_array_member_not_at_end = 629,   /* -Wflex-array-member-not-at-end */
  OPT_Wfloat_conversion = 630,               /* -Wfloat-conversion */
  OPT_Wfloat_equal = 631,                    /* -Wfloat-equal */
  /* OPT_Wformat = 632, */                   /* -Wformat */
  OPT_Wformat_contains_nul = 633,            /* -Wformat-contains-nul */
  OPT_Wformat_diag = 634,                    /* -Wformat-diag */
  OPT_Wformat_extra_args = 635,              /* -Wformat-extra-args */
  OPT_Wformat_nonliteral = 636,              /* -Wformat-nonliteral */
  /* OPT_Wformat_overflow = 637, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 638,               /* -Wformat-overflow= */
  OPT_Wformat_security = 639,                /* -Wformat-security */
  OPT_Wformat_signedness = 640,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 641, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 642,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 643,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 644,             /* -Wformat-zero-length */
  OPT_Wformat_ = 645,                        /* -Wformat= */
  OPT_Wframe_address = 646,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 647,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 648,            /* -Wfree-nonheap-object */
  OPT_Wfrontend_loop_interchange = 649,      /* -Wfrontend-loop-interchange */
  OPT_Wfunction_elimination = 650,           /* -Wfunction-elimination */
  OPT_Wglobal_module = 651,                  /* -Wglobal-module */
  OPT_Whardened = 652,                       /* -Whardened */
  /* OPT_Whsa = 653, */                      /* -Whsa */
  OPT_Wif_not_aligned = 654,                 /* -Wif-not-aligned */
  OPT_Wignored_attributes = 655,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 656,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 657,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 658, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 659,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 660,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 661,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 662,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 663,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 664, */                   /* -Wimport */
  OPT_Winaccessible_base = 665,              /* -Winaccessible-base */
  OPT_Wincompatible_pointer_types = 666,     /* -Wincompatible-pointer-types */
  OPT_Winfinite_recursion = 667,             /* -Winfinite-recursion */
  OPT_Winherited_variadic_ctor = 668,        /* -Winherited-variadic-ctor */
  OPT_Winit_list_lifetime = 669,             /* -Winit-list-lifetime */
  OPT_Winit_self = 670,                      /* -Winit-self */
  OPT_Winline = 671,                         /* -Winline */
  OPT_Wint_conversion = 672,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 673,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 674,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 675,               /* -Winteger-division */
  OPT_Winterference_size = 676,              /* -Winterference-size */
  OPT_Wintrinsic_shadow = 677,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 678,                 /* -Wintrinsics-std */
  OPT_Winvalid_constexpr = 679,              /* -Winvalid-constexpr */
  OPT_Winvalid_imported_macros = 680,        /* -Winvalid-imported-macros */
  OPT_Winvalid_memory_model = 681,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 682,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 683,                    /* -Winvalid-pch */
  OPT_Winvalid_utf8 = 684,                   /* -Winvalid-utf8 */
  OPT_Wjump_misses_init = 685,               /* -Wjump-misses-init */
  OPT_Wl_ = 686,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 687, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 688,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 689,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 690,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 691,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 692,                     /* -Wlogical-op */
  OPT_Wlong_long = 693,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 694,              /* -Wlto-type-mismatch */
  OPT_Wmain = 695,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 696,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 697,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 698,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 699,         /* -Wmisleading-indentation */
  OPT_Wmismatched_dealloc = 700,             /* -Wmismatched-dealloc */
  OPT_Wmismatched_new_delete = 701,          /* -Wmismatched-new-delete */
  OPT_Wmismatched_special_enum = 702,        /* -Wmismatched-special-enum */
  OPT_Wmismatched_tags = 703,                /* -Wmismatched-tags */
  OPT_Wmissing_attributes = 704,             /* -Wmissing-attributes */
  OPT_Wmissing_braces = 705,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 706,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 707,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 708, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 709,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 710, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 711,         /* -Wmissing-parameter-type */
  OPT_Wmissing_profile = 712,                /* -Wmissing-profile */
  OPT_Wmissing_prototypes = 713,             /* -Wmissing-prototypes */
  OPT_Wmissing_requires = 714,               /* -Wmissing-requires */
  OPT_Wmissing_template_keyword = 715,       /* -Wmissing-template-keyword */
  OPT_Wmissing_variable_declarations = 716,  /* -Wmissing-variable-declarations */
  OPT_Wmudflap = 717,                        /* -Wmudflap */
  OPT_Wmultichar = 718,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 719,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 720,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 721,                     /* -Wnamespaces */
  OPT_Wnarrowing = 722,                      /* -Wnarrowing */
  OPT_Wnested_externs = 723,                 /* -Wnested-externs */
  /* OPT_Wno_alloc_size_larger_than = 724, *//* -Wno-alloc-size-larger-than */
  /* OPT_Wno_alloca_larger_than = 725, */    /* -Wno-alloca-larger-than */
  /* OPT_Wno_frame_larger_than = 726, */     /* -Wno-frame-larger-than */
  /* OPT_Wno_larger_than = 727, */           /* -Wno-larger-than */
  /* OPT_Wno_stack_usage = 728, */           /* -Wno-stack-usage */
  /* OPT_Wno_vla_larger_than = 729, */       /* -Wno-vla-larger-than */
  OPT_Wnoexcept = 730,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 731,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 732,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 733,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 734,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 735,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 736, */               /* -Wnormalized */
  OPT_Wnormalized_ = 737,                    /* -Wnormalized= */
  OPT_Wnrvo = 738,                           /* -Wnrvo */
  OPT_Wnull_dereference = 739,               /* -Wnull-dereference */
  OPT_Wobjc_root_class = 740,                /* -Wobjc-root-class */
  OPT_Wodr = 741,                            /* -Wodr */
  OPT_Wold_style_cast = 742,                 /* -Wold-style-cast */
  OPT_Wold_style_declaration = 743,          /* -Wold-style-declaration */
  OPT_Wold_style_definition = 744,           /* -Wold-style-definition */
  OPT_Wopenacc_parallelism = 745,            /* -Wopenacc-parallelism */
  OPT_Wopenmp = 746,                         /* -Wopenmp */
  OPT_Wopenmp_simd = 747,                    /* -Wopenmp-simd */
  OPT_Woverflow = 748,                       /* -Woverflow */
  OPT_Woverlength_strings = 749,             /* -Woverlength-strings */
  /* OPT_Woverloaded_virtual = 750, */       /* -Woverloaded-virtual */
  OPT_Woverloaded_virtual_ = 751,            /* -Woverloaded-virtual= */
  OPT_Woverride_init = 752,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 753,     /* -Woverride-init-side-effects */
  OPT_Woverwrite_recursive = 754,            /* -Woverwrite-recursive */
  OPT_Wp_ = 755,                             /* -Wp, */
  OPT_Wpacked = 756,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 757,         /* -Wpacked-bitfield-compat */
  OPT_Wpacked_not_aligned = 758,             /* -Wpacked-not-aligned */
  OPT_Wpadded = 759,                         /* -Wpadded */
  OPT_Wparentheses = 760,                    /* -Wparentheses */
  OPT_Wpedantic = 761,                       /* -Wpedantic */
  OPT_Wpedantic_cast = 762,                  /* -Wpedantic-cast */
  ...
  OPT_fshared = 1700,                        /* -fshared */
  OPT_fshort_enums = 1701,                   /* -fshort-enums */
  OPT_fshort_wchar = 1702,                   /* -fshort-wchar */
  OPT_fshow_column = 1703,                   /* -fshow-column */
  OPT_fshrink_wrap = 1704,                   /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 1705,          /* -fshrink-wrap-separate */
  OPT_fsign_zero = 1706,                     /* -fsign-zero */
  OPT_fsignaling_nans = 1707,                /* -fsignaling-nans */
  OPT_fsigned_bitfields = 1708,              /* -fsigned-bitfields */
  OPT_fsigned_char = 1709,                   /* -fsigned-char */
  OPT_fsigned_zeros = 1710,                  /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 1711,              /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 1712,     /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 1713,            /* -fsized-deallocation */
  OPT_fsoft_check_all = 1714,                /* -fsoft-check-all */
  OPT_fsources = 1715,                       /* -fsources */
  OPT_fsplit_ivs_in_unroller = 1716,         /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 1717,                   /* -fsplit-loops */
  OPT_fsplit_paths = 1718,                   /* -fsplit-paths */
  OPT_fsplit_stack = 1719,                   /* -fsplit-stack */
  OPT_fsplit_wide_types = 1720,              /* -fsplit-wide-types */
  OPT_fsplit_wide_types_early = 1721,        /* -fsplit-wide-types-early */
  OPT_fsquangle = 1722,                      /* -fsquangle */
  OPT_fssa_backprop = 1723,                  /* -fssa-backprop */
  OPT_fssa_phiopt = 1724,                    /* -fssa-phiopt */
  OPT_fsso_struct_ = 1725,                   /* -fsso-struct= */
  OPT_fstack_arrays = 1726,                  /* -fstack-arrays */
  /* OPT_fstack_check = 1727, */             /* -fstack-check */
  OPT_fstack_check_ = 1728,                  /* -fstack-check= */
  OPT_fstack_clash_protection = 1729,        /* -fstack-clash-protection */
  OPT_fstack_limit = 1730,                   /* -fstack-limit */
  OPT_fstack_limit_register_ = 1731,         /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 1732,           /* -fstack-limit-symbol= */
  OPT_fstack_protector = 1733,               /* -fstack-protector */
  OPT_fstack_protector_all = 1734,           /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 1735,      /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 1736,        /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 1737,                  /* -fstack-reuse= */
  OPT_fstack_usage = 1738,                   /* -fstack-usage */
  OPT_fstats = 1739,                         /* -fstats */
  OPT_fstdarg_opt = 1740,                    /* -fstdarg-opt */
  OPT_fstore_merging = 1741,                 /* -fstore-merging */
  /* OPT_fstrength_reduce = 1742, */         /* -fstrength-reduce */
  OPT_fstrict_aliasing = 1743,               /* -fstrict-aliasing */
  OPT_fstrict_enums = 1744,                  /* -fstrict-enums */
  /* OPT_fstrict_flex_arrays = 1745, */      /* -fstrict-flex-arrays */
  OPT_fstrict_flex_arrays_ = 1746,           /* -fstrict-flex-arrays= */
  OPT_fstrict_overflow = 1747,               /* -fstrict-overflow */
  OPT_fstrict_prototype = 1748,              /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1749,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1750, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1751,            /* -fstrong-eval-order= */
  OPT_fstrub_all = 1752,                     /* -fstrub=all */
  OPT_fstrub_at_calls = 1753,                /* -fstrub=at-calls */
  OPT_fstrub_disable = 1754,                 /* -fstrub=disable */
  OPT_fstrub_internal = 1755,                /* -fstrub=internal */
  OPT_fstrub_relaxed = 1756,                 /* -fstrub=relaxed */
  OPT_fstrub_strict = 1757,                  /* -fstrub=strict */
  OPT_fswig = 1758,                          /* -fswig */
  OPT_fswitch_errors = 1759,                 /* -fswitch-errors */
  OPT_fsync_libcalls = 1760,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1761,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1762,                      /* -ftabstop= */
  /* OPT_ftail_call_workaround = 1763, */    /* -ftail-call-workaround */
  OPT_ftail_call_workaround_ = 1764,         /* -ftail-call-workaround= */
  /* OPT_ftarget_help = 1765, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1766,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1767, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1768,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1769,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1770,              /* -ftest-forall-temp */
  OPT_fthis_is_variable = 1771,              /* -fthis-is-variable */
  OPT_fthread_jumps = 1772,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1773,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1774,                   /* -ftime-report */
  OPT_ftime_report_details = 1775,           /* -ftime-report-details */
  OPT_ftls_model_ = 1776,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1777,              /* -ftoplevel-reorder */
  OPT_ftracer = 1778,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1779,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1780,        /* -ftrack-macro-expansion= */
  OPT_ftrampoline_impl_ = 1781,              /* -ftrampoline-impl= */
  OPT_ftrampolines = 1782,                   /* -ftrampolines */
  OPT_ftransition_all = 1783,                /* -ftransition=all */
  OPT_ftransition_field = 1784,              /* -ftransition=field */
  OPT_ftransition_in = 1785,                 /* -ftransition=in */
  OPT_ftransition_nogc = 1786,               /* -ftransition=nogc */
  OPT_ftransition_templates = 1787,          /* -ftransition=templates */
  OPT_ftransition_tls = 1788,                /* -ftransition=tls */
  OPT_ftrapping_math = 1789,                 /* -ftrapping-math */
  OPT_ftrapv = 1790,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1791,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1792,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1793,                      /* -ftree-ccp */
  OPT_ftree_ch = 1794,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1795, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1796,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1797,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1798, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1799,                   /* -ftree-cselim */
  OPT_ftree_dce = 1800,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1801,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1802,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1803,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1804,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1805, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1806,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1807,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1808, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1809,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1810,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1811, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1812,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1813,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1814,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1815,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1816,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1817,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1818,                      /* -ftree-pre */
  OPT_ftree_pta = 1819,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1820,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1821, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1822,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1823,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1824,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1825,                     /* -ftree-slsr */
  OPT_ftree_sra = 1826,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1827, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1828, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1829,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1830,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1831,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1832, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1833,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1834, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1835,                      /* -ftree-vrp */
  OPT_ftrivial_auto_var_init_ = 1836,        /* -ftrivial-auto-var-init= */
  OPT_funbounded_by_reference = 1837,        /* -funbounded-by-reference */
  OPT_funconstrained_commons = 1838,         /* -funconstrained-commons */
  OPT_funderscoring = 1839,                  /* -funderscoring */
  OPT_funit_at_a_time = 1840,                /* -funit-at-a-time */
  OPT_funittest = 1841,                      /* -funittest */
  OPT_funreachable_traps = 1842,             /* -funreachable-traps */
  OPT_funroll_all_loops = 1843,              /* -funroll-all-loops */
  OPT_funroll_completely_grow_size = 1844,   /* -funroll-completely-grow-size */
  OPT_funroll_loops = 1845,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1846, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1847,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1848,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1849,                 /* -funsigned-char */
  OPT_funswitch_loops = 1850,                /* -funswitch-loops */
  OPT_funwind_tables = 1851,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1852,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1853,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1854,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1855,                   /* -fuse-ld=gold */
  OPT_fuse_ld_lld = 1856,                    /* -fuse-ld=lld */
  OPT_fuse_ld_mold = 1857,                   /* -fuse-ld=mold */
  OPT_fuse_linker_plugin = 1858,             /* -fuse-linker-plugin */
  OPT_fuse_list_ = 1859,                     /* -fuse-list= */
  OPT_fvar_tracking = 1860,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1861,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1862,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1863,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1864,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1865, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1866,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1867,                   /* -fverbose-asm */
  /* OPT_fversion = 1868, */                 /* -fversion */
  OPT_fversion_loops_for_strides = 1869,     /* -fversion-loops-for-strides */
  OPT_fversion_ = 1870,                      /* -fversion= */
  OPT_fvisibility_inlines_hidden = 1871,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1872,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1873,                   /* -fvisibility= */
  OPT_fvpt = 1874,                           /* -fvpt */
  OPT_fvtable_gc = 1875,                     /* -fvtable-gc */
  OPT_fvtable_thunks = 1876,                 /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1877,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1878,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1879,                     /* -fvtv-debug */
  OPT_fweak = 1880,                          /* -fweak */
  OPT_fweak_templates = 1881,                /* -fweak-templates */
  OPT_fweb = 1882,                           /* -fweb */
  /* OPT_fwhole_file = 1883, */              /* -fwhole-file */
  OPT_fwhole_program = 1884,                 /* -fwhole-program */
  OPT_fwholediv = 1885,                      /* -fwholediv */
  OPT_fwholevalue = 1886,                    /* -fwholevalue */
  OPT_fwide_exec_charset_ = 1887,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1888,             /* -fworking-directory */
  OPT_fwpa = 1889,                           /* -fwpa */
  OPT_fwpa_ = 1890,                          /* -fwpa= */
  OPT_fwrapv = 1891,                         /* -fwrapv */
  OPT_fwrapv_pointer = 1892,                 /* -fwrapv-pointer */
  OPT_fxref = 1893,                          /* -fxref */
  /* OPT_fzee = 1894, */                     /* -fzee */
  OPT_fzero_call_used_regs_ = 1895,          /* -fzero-call-used-regs= */
  OPT_fzero_initialized_in_bss = 1896,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1897,                     /* -fzero-link */
  OPT_g = 1898,                              /* -g */
  OPT_gant = 1899,                           /* -gant */
  OPT_gas_loc_support = 1900,                /* -gas-loc-support */
  OPT_gas_locview_support = 1901,            /* -gas-locview-support */
  OPT_gbtf = 1902,                           /* -gbtf */
  OPT_gcodeview = 1903,                      /* -gcodeview */
  OPT_gcoff = 1904,                          /* -gcoff */
  OPT_gcoff1 = 1905,                         /* -gcoff1 */
  OPT_gcoff2 = 1906,                         /* -gcoff2 */
  OPT_gcoff3 = 1907,                         /* -gcoff3 */
  OPT_gcolumn_info = 1908,                   /* -gcolumn-info */
  OPT_gctf = 1909,                           /* -gctf */
  OPT_gdescribe_dies = 1910,                 /* -gdescribe-dies */
  OPT_gdwarf = 1911,                         /* -gdwarf */
  OPT_gdwarf_ = 1912,                        /* -gdwarf- */
  OPT_gdwarf32 = 1913,                       /* -gdwarf32 */
  OPT_gdwarf64 = 1914,                       /* -gdwarf64 */
  OPT_gen_decls = 1915,                      /* -gen-decls */
  OPT_ggdb = 1916,                           /* -ggdb */
  OPT_ggnu_pubnames = 1917,                  /* -ggnu-pubnames */
  OPT_gimple_stats = 1918,                   /* -gimple-stats */
  OPT_ginline_points = 1919,                 /* -ginline-points */
  OPT_ginternal_reset_location_views = 1920, /* -ginternal-reset-location-views */
  OPT_gnat = 1921,                           /* -gnat */
  OPT_gnatO = 1922,                          /* -gnatO */
  OPT_gno_ = 1923,                           /* -gno- */
  OPT_gno_pubnames = 1924,                   /* -gno-pubnames */
  OPT_gpubnames = 1925,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1926,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1927,                   /* -gsplit-dwarf */
  OPT_gstabs = 1928,                         /* -gstabs */
  OPT_gstabs_ = 1929,                        /* -gstabs+ */
  OPT_gstatement_frontiers = 1930,           /* -gstatement-frontiers */
  OPT_gstrict_dwarf = 1931,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1932,                        /* -gtoggle */
  OPT_gvariable_location_views = 1933,       /* -gvariable-location-views */
  OPT_gvariable_location_views_incompat5 = 1934,/* -gvariable-location-views=incompat5 */
  OPT_gvms = 1935,                           /* -gvms */
  OPT_gxcoff = 1936,                         /* -gxcoff */
  OPT_gxcoff_ = 1937,                        /* -gxcoff+ */
  OPT_gz = 1938,                             /* -gz */
  OPT_gz_ = 1939,                            /* -gz= */
  OPT_h = 1940,                              /* -h */
  OPT_help = 1941,                           /* -help */
  OPT_idirafter = 1942,                      /* -idirafter */
  OPT_imacros = 1943,                        /* -imacros */
  OPT_imultiarch = 1944,                     /* -imultiarch */
  OPT_imultilib = 1945,                      /* -imultilib */
  OPT_include = 1946,                        /* -include */
  OPT_iplugindir_ = 1947,                    /* -iplugindir= */
  OPT_iprefix = 1948,                        /* -iprefix */
  OPT_iquote = 1949,                         /* -iquote */
  OPT_isysroot = 1950,                       /* -isysroot */
  OPT_isystem = 1951,                        /* -isystem */
  OPT_iwithprefix = 1952,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1953,              /* -iwithprefixbefore */
  OPT_k8 = 1954,                             /* -k8 */
  OPT_l = 1955,                              /* -l */
  OPT_lang_asm = 1956,                       /* -lang-asm */
  OPT_list = 1957,                           /* -list */
  OPT_mabi_ = 1958,                          /* -mabi= */
  OPT_mabicalls = 1959,                      /* -mabicalls */
  OPT_mabs_ = 1960,                          /* -mabs= */
  OPT_march_ = 1961,                         /* -march= */
  OPT_mbranch_cost_ = 1962,                  /* -mbranch-cost= */
  OPT_mbranch_likely = 1963,                 /* -mbranch-likely */
  OPT_mcheck_zero_division = 1964,           /* -mcheck-zero-division */
  OPT_mcode_readable_ = 1965,                /* -mcode-readable= */
  OPT_mcompact_branches_ = 1966,             /* -mcompact-branches= */
  OPT_mcrc = 1967,                           /* -mcrc */
  OPT_mdebug = 1968,                         /* -mdebug */
  OPT_mdebugd = 1969,                        /* -mdebugd */
  OPT_mdivide_breaks = 1970,                 /* -mdivide-breaks */
  OPT_mdivide_traps = 1971,                  /* -mdivide-traps */
  OPT_mdmx = 1972,                           /* -mdmx */
  OPT_mdouble_float = 1973,                  /* -mdouble-float */
  OPT_mdsp = 1974,                           /* -mdsp */
  OPT_mdspr2 = 1975,                         /* -mdspr2 */
  OPT_meb = 1976,                            /* -meb */
  OPT_mel = 1977,                            /* -mel */
  OPT_membedded_data = 1978,                 /* -membedded-data */
  OPT_meva = 1979,                           /* -meva */
  /* OPT_mexplicit_relocs = 1980, */         /* -mexplicit-relocs */
  OPT_mexplicit_relocs_ = 1981,              /* -mexplicit-relocs= */
  OPT_mextern_sdata = 1982,                  /* -mextern-sdata */
  OPT_mfix_24k = 1983,                       /* -mfix-24k */
  OPT_mfix_r10000 = 1984,                    /* -mfix-r10000 */
  OPT_mfix_r4000 = 1985,                     /* -mfix-r4000 */
  OPT_mfix_r4400 = 1986,                     /* -mfix-r4400 */
  OPT_mfix_r5900 = 1987,                     /* -mfix-r5900 */
  OPT_mfix_rm7000 = 1988,                    /* -mfix-rm7000 */
  OPT_mfix_sb1 = 1989,                       /* -mfix-sb1 */
  OPT_mfix_vr4120 = 1990,                    /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 1991,                    /* -mfix-vr4130 */
  OPT_mfix4300 = 1992,                       /* -mfix4300 */
  OPT_mflip_mips16 = 1993,                   /* -mflip-mips16 */
  OPT_mflush_func_ = 1994,                   /* -mflush-func= */
  OPT_mfp_exceptions = 1995,                 /* -mfp-exceptions */
  OPT_mfp32 = 1996,                          /* -mfp32 */
  OPT_mfp64 = 1997,                          /* -mfp64 */
  OPT_mfpxx = 1998,                          /* -mfpxx */
  OPT_mframe_header_opt = 1999,              /* -mframe-header-opt */
  /* OPT_mfused_madd = 2000, */              /* -mfused-madd */
  OPT_mginv = 2001,                          /* -mginv */
  OPT_mgp32 = 2002,                          /* -mgp32 */
  OPT_mgp64 = 2003,                          /* -mgp64 */
  OPT_mgpopt = 2004,                         /* -mgpopt */
  OPT_mhard_float = 2005,                    /* -mhard-float */
  OPT_mimadd = 2006,                         /* -mimadd */
  OPT_minterlink_compressed = 2007,          /* -minterlink-compressed */
  OPT_minterlink_mips16 = 2008,              /* -minterlink-mips16 */
  OPT_mips = 2009,                           /* -mips */
  OPT_mips16 = 2010,                         /* -mips16 */
  OPT_mips3d = 2011,                         /* -mips3d */
  OPT_mllsc = 2012,                          /* -mllsc */
  OPT_mload_store_pairs = 2013,              /* -mload-store-pairs */
  OPT_mlocal_sdata = 2014,                   /* -mlocal-sdata */
  OPT_mlong_calls = 2015,                    /* -mlong-calls */
  OPT_mlong32 = 2016,                        /* -mlong32 */
  OPT_mlong64 = 2017,                        /* -mlong64 */
  OPT_mloongson_ext = 2018,                  /* -mloongson-ext */
  OPT_mloongson_ext2 = 2019,                 /* -mloongson-ext2 */
  OPT_mloongson_mmi = 2020,                  /* -mloongson-mmi */
  OPT_mlra = 2021,                           /* -mlra */
  OPT_mlxc1_sxc1 = 2022,                     /* -mlxc1-sxc1 */
  OPT_mmad = 2023,                           /* -mmad */
  OPT_mmadd4 = 2024,                         /* -mmadd4 */
  OPT_mmcount_ra_address = 2025,             /* -mmcount-ra-address */
  OPT_mmcu = 2026,                           /* -mmcu */
  OPT_mmemcpy = 2027,                        /* -mmemcpy */
  OPT_mmicromips = 2028,                     /* -mmicromips */
  OPT_mmips16e2 = 2029,                      /* -mmips16e2 */
  OPT_mmsa = 2030,                           /* -mmsa */
  OPT_mmt = 2031,                            /* -mmt */
  OPT_mnan_ = 2032,                          /* -mnan= */
  /* OPT_mno_explicit_relocs = 2033, */      /* -mno-explicit-relocs */
  OPT_mno_float = 2034,                      /* -mno-float */
  OPT_mno_flush_func = 2035,                 /* -mno-flush-func */
  OPT_mno_mdmx = 2036,                       /* -mno-mdmx */
  OPT_mno_mips16 = 2037,                     /* -mno-mips16 */
  OPT_mno_mips3d = 2038,                     /* -mno-mips3d */
  /* OPT_mno_unaligned_access = 2039, */     /* -mno-unaligned-access */
  OPT_modd_spreg = 2040,                     /* -modd-spreg */
  OPT_mpaired_single = 2041,                 /* -mpaired-single */
  OPT_mplt = 2042,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 2043,     /* -mpreferred-stack-boundary= */
  OPT_mr10k_cache_barrier_ = 2044,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 2045,               /* -mrelax-pic-calls */
  OPT_mshared = 2046,                        /* -mshared */
  OPT_msingle_float = 2047,                  /* -msingle-float */
  OPT_msmartmips = 2048,                     /* -msmartmips */
  OPT_msoft_float = 2049,                    /* -msoft-float */
  OPT_msplit_addresses = 2050,               /* -msplit-addresses */
  OPT_mstrict_align = 2051,                  /* -mstrict-align */
  OPT_msym32 = 2052,                         /* -msym32 */
  OPT_msynci = 2053,                         /* -msynci */
  OPT_mtune_ = 2054,                         /* -mtune= */
  /* OPT_munaligned_access = 2055, */        /* -munaligned-access */
  OPT_muninit_const_in_rodata = 2056,        /* -muninit-const-in-rodata */
  OPT_mvirt = 2057,                          /* -mvirt */
  OPT_mvr4130_align = 2058,                  /* -mvr4130-align */
  OPT_mxgot = 2059,                          /* -mxgot */
  OPT_mxpa = 2060,                           /* -mxpa */
  OPT_n = 2061,                              /* -n */
  OPT_name_sort = 2062,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2063,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2064,              /* -no-integrated-cpp */
  OPT_no_pie = 2065,                         /* -no-pie */
  OPT_noasmopt = 2066,                       /* -noasmopt */
  OPT_nocpp = 2067,                          /* -nocpp */
  OPT_nodefaultlibs = 2068,                  /* -nodefaultlibs */
  OPT_nolibc = 2069,                         /* -nolibc */
  OPT_nophoboslib = 2070,                    /* -nophoboslib */
  OPT_nostartfiles = 2071,                   /* -nostartfiles */
  OPT_nostdinc = 2072,                       /* -nostdinc */
  OPT_nostdinc__ = 2073,                     /* -nostdinc++ */
  OPT_nostdlib = 2074,                       /* -nostdlib */
  OPT_nostdlib__ = 2075,                     /* -nostdlib++ */
  OPT_o = 2076,                              /* -o */
  OPT_objects = 2077,                        /* -objects */
  OPT_p = 2078,                              /* -p */
  OPT_pass_exit_codes = 2079,                /* -pass-exit-codes */
  /* OPT_pedantic = 2080, */                 /* -pedantic */
  OPT_pedantic_errors = 2081,                /* -pedantic-errors */
  OPT_pg = 2082,                             /* -pg */
  OPT_pie = 2083,                            /* -pie */
  OPT_pipe = 2084,                           /* -pipe */
  ...
  OPT_quiet = 2097,                          /* -quiet */
  OPT_r = 2098,                              /* -r */
  OPT_remap = 2099,                          /* -remap */
  OPT_reverse_sort = 2100,                   /* -reverse-sort */
  OPT_s = 2101,                              /* -s */
  OPT_save_temps = 2102,                     /* -save-temps */
  OPT_save_temps_ = 2103,                    /* -save-temps= */
  OPT_shared = 2104,                         /* -shared */
  OPT_shared_libgcc = 2105,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2106,               /* -shared-libphobos */
  OPT_size_sort = 2107,                      /* -size-sort */
  /* OPT_specs = 2108, */                    /* -specs */
  OPT_specs_ = 2109,                         /* -specs= */
  OPT_static = 2110,                         /* -static */
  OPT_static_libasan = 2111,                 /* -static-libasan */
  OPT_static_libgcc = 2112,                  /* -static-libgcc */
  OPT_static_libgfortran = 2113,             /* -static-libgfortran */
  OPT_static_libgm2 = 2114,                  /* -static-libgm2 */
  OPT_static_libgo = 2115,                   /* -static-libgo */
  OPT_static_libhwasan = 2116,               /* -static-libhwasan */
  OPT_static_liblsan = 2117,                 /* -static-liblsan */
  OPT_static_libmpx = 2118,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2119,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2120,               /* -static-libphobos */
  OPT_static_libquadmath = 2121,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2122,               /* -static-libstdc++ */
  OPT_static_libtsan = 2123,                 /* -static-libtsan */
  OPT_static_libubsan = 2124,                /* -static-libubsan */
  OPT_static_pie = 2125,                     /* -static-pie */
  /* OPT_std_c__03 = 2126, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2127, */                /* -std=c++0x */
  OPT_std_c__11 = 2128,                      /* -std=c++11 */
  OPT_std_c__14 = 2129,                      /* -std=c++14 */
  OPT_std_c__17 = 2130,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2131, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2132, */                /* -std=c++1z */
  OPT_std_c__20 = 2133,                      /* -std=c++20 */
  OPT_std_c__23 = 2134,                      /* -std=c++23 */
  OPT_std_c__26 = 2135,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2136, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2137, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2138, */                /* -std=c++2c */
  OPT_std_c__98 = 2139,                      /* -std=c++98 */
  OPT_std_c11 = 2140,                        /* -std=c11 */
  OPT_std_c17 = 2141,                        /* -std=c17 */
  /* OPT_std_c18 = 2142, */                  /* -std=c18 */
  /* OPT_std_c1x = 2143, */                  /* -std=c1x */
  OPT_std_c23 = 2144,                        /* -std=c23 */
  /* OPT_std_c2x = 2145, */                  /* -std=c2x */
  /* OPT_std_c89 = 2146, */                  /* -std=c89 */
  OPT_std_c90 = 2147,                        /* -std=c90 */
  OPT_std_c99 = 2148,                        /* -std=c99 */
  /* OPT_std_c9x = 2149, */                  /* -std=c9x */
  OPT_std_f2003 = 2150,                      /* -std=f2003 */
  OPT_std_f2008 = 2151,                      /* -std=f2008 */
  OPT_std_f2008ts = 2152,                    /* -std=f2008ts */
  OPT_std_f2018 = 2153,                      /* -std=f2018 */
  OPT_std_f2023 = 2154,                      /* -std=f2023 */
  ...
  /* OPT_std_gnu89 = 2177, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2178,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2179,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2180, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2181, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2182,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2183, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2184, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2185, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2186, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2187, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2188, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2189,                     /* -std=legacy */
  OPT_stdlib_ = 2190,                        /* -stdlib= */
  OPT_symbol_ = 2191,                        /* -symbol= */
  OPT_symbolic = 2192,                       /* -symbolic */
  OPT_t = 2193,                              /* -t */
  OPT_time = 2194,                           /* -time */
  OPT_time_ = 2195,                          /* -time= */
  OPT_traditional = 2196,                    /* -traditional */
  OPT_traditional_cpp = 2197,                /* -traditional-cpp */
  OPT_tree_stats = 2198,                     /* -tree-stats */
  OPT_trigraphs = 2199,                      /* -trigraphs */
  OPT_type_stats = 2200,                     /* -type-stats */
  OPT_u = 2201,                              /* -u */
  OPT_undef = 2202,                          /* -undef */
  OPT_v = 2203,                              /* -v */
  OPT_version = 2204,                        /* -version */
  OPT_w = 2205,                              /* -w */
  OPT_wrapper = 2206,                        /* -wrapper */
  OPT_x = 2207,                              /* -x */
  OPT_z = 2208,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
